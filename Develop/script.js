...
function writePassword() {
  ...
  var pCriteria = {
    ...
    symbols: { indexNumber: 3, criteria: "!?$.*&@#"},
  }
  
  window.alert("The criteria for password generator are lowercase, uppercase, special characters, and numbers");
  var validInput = true;

  while(validInput){
    userInput = window.prompt ("Select password using one or more of the criteria.") 
  }
    if (!userInput) {
      window.alert ("If you wish to close the application, please close this generator tab")
    } else if (userInput){
